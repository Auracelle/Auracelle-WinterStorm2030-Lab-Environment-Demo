...
.st-key-vector_tile_grid .stButton>button[kind="secondary"]{background:rgba(9,33,49,.55)!important;color:var(--ice)!important;border:1.5px solid var(--line)!important;box-shadow:none!important}
.st-key-vector_tile_grid .stButton>button[kind="secondary"]:hover{border-color:var(--cyan)!important}
.st-key-vector_tile_grid .stButton>button[kind="primary"]{background:radial-gradient(circle at 30% 20%,rgba(122,231,244,.32),rgba(122,231,244,.12))!important;border:1.5px solid var(--cyan)!important;color:var(--cyan2)!important;box-shadow:0 0 0 2px var(--cyan),0 0 14px rgba(122,231,244,.65),0 0 42px rgba(122,231,244,.35)!important}
