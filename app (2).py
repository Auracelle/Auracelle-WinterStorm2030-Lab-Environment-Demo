...
if not st.session_state["authenticated"]:
    ...
    <div class="ws-hero">
      ...
      <div class="ws-subtitle">WinterStorm2030 measures the gap between grey-zone activity and NATO's Article 4/5 thresholds — scoring how urgent a decision is, and stress-testing where existing NATO policy has no clear answer. It draws on real-time event data and historical treaty precedent (including the Washington Naval Treaty and other grey-zone/infrastructure-dispute analogues) to build an evidence-grounded case for a NATO Treaty addendum or revision recommendation by 2030 — a Disruptive Capabilities deliverable, not a combat simulator.</div>
      <div class="ws-badges">
