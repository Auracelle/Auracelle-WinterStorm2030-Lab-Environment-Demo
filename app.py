...
with tab_osint:
    ...
    st.write("Pull unclassified event reporting from the GDELT Project, then tag selected events into the Concession Engine, Article 4 stress-test log, or the non-scoring Hormuz calibration baseline.")
    ocols = st.columns(3)
